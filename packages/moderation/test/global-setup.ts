...
export default function setup() {
  const url = process.env.MODERATION_TEST_DATABASE_URL ?? "postgresql://postgres:postgres@localhost:5432/dinkuan_moderation_test";
  const cwd = fileURLToPath(new URL("../../db", import.meta.url));
